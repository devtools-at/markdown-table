...
<p align="center">
  <a href="https://devtools.at/tools/markdown-table"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
  <a href="https://www.npmjs.com/package/@devtools-at/markdown-table"><img src="https://img.shields.io/npm/v/@devtools-at/markdown-table?style=for-the-badge" alt="npm version"></a>
  <a href="https://www.npmjs.com/package/@devtools-at/markdown-table"><img src="https://img.shields.io/npm/dm/@devtools-at/markdown-table?style=for-the-badge" alt="npm downloads"></a>
  <img src="https://img.shields.io/badge/TypeScript-Ready-3178C6?style=for-the-badge&logo=typescript" alt="TypeScript Ready">
</p>

<p align="center">
  <b>Generate Markdown tables</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/markdown-table">Online Tool</a> •
...
```bash
# npm
npm install @devtools-at/markdown-table

# yarn
yarn add @devtools-at/markdown-table

# pnpm
pnpm add @devtools-at/markdown-table
```

## Usage

```typescript
import { process } from '@devtools-at/markdown-table';
...
```typescript
import { encode, decode } from '@devtools-at/markdown-table';
```

### CommonJS Require

```javascript
const { encode, decode } = require('@devtools-at/markdown-table');
```

### Browser (CDN)

```html
<script src="https://unpkg.com/@devtools-at/markdown-table"></script>
<script>
  const result = DevToolsMarkdownTable.encode('data');
</script>
```
...
### **[Markdown Table Generator - DevTools.at](https://devtools.at/tools/markdown-table)**
